...
namespace Metro
{
    ...
    public class NetworkInterface
    {
        ...
        ///		The IP address of the interface.
        /// </summary>
        public IPAddress Address { get => m_address; set => m_address = value; }

        /// <summary>
        ///		The subnet mask.
        /// </summary>
        public IPAddress SubnetMask { get => m_subnetMask; set => m_subnetMask = value; }

        /// <summary>
        ///		The broadcast address.
        /// </summary>
        public IPAddress BroadcastAddress { get => m_broadcastAddress; set => m_broadcastAddress = value; }
        ...
        ///		Whether or not this is the loopback interface.
        /// </summary>
        public bool isLoopback { get => m_loopback; set => m_loopback = value; }

        /// <summary>
        ///		Whether or not this is a point to point link.
        /// </summary>
        public bool IsPointToPointLink { get => m_pointToPointLink; set => m_pointToPointLink = value; }

        /// <summary>
        ///		Whether or not this interface supports broadcasting.
        /// </summary>
        public bool SupportsBroadcast { get => m_broadcast; set => m_broadcast = value; }

        /// <summary>
        ///		Whether or not this interface supports multicasting.
        /// </summary>
        public bool SupportMulticast { get => m_multiCast; set => m_multiCast = value; }

        /// <summary>
        ///		The interface index.
        /// </summary>
        public int InterfaceIndex { get => m_interfaceIndex; set => m_interfaceIndex = value; }
    ...
    public class NetworkInterfaceList
    {
        ...
        ///		The array of network interfaces.
        /// </summary>
        public NetworkInterface[] Interfaces => interfaces;

        /// <summary>
        ///		Returns a network interface.
        /// </summary>
        public NetworkInterface this[int index] => interfaces[index];
                        ...
                        if (intIP > 0)
                        {
                            ...
                            for (int j = 0; j < interfaces.Length; j++)
                            {
                                if (interfaces[j].Address.Equals(ip))
                                {
                                    ...
                                    interfaces[j].InterfaceIndex =
                                        Marshal.ReadInt32(new IntPtr(pBuffer.ToInt32() + 8 + i * 24));
                                }
                            }
                        }
                        else
