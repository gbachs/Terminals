...
namespace Terminals.Data
{
    ...
    public class Group : IGroup
    {
        ...
        public string Name
        {
            ...
            set
            {
                if (Settings.Instance.AutoCaseTags)
                    this.name = TextConverter.ToTitleCase(value);
                this.name = value;
            }
        }

        [XmlIgnore] List<IFavorite> IGroup.Favorites => this.favorites.Values.ToList();
        ...
        {
            var favoriteIds = this.favorites.Keys.ToArray();
        ...
        {
            var current = this.favorites.Values.ToList();
            var someRemoved = this.RemoveRedundantFavorites(current, newFavorites);
            var someAdded = this.AddMissingFavorites(current, newFavorites);
        ...
        private bool AddMissingFavorites(List<IFavorite> current, List<IFavorite> newFavorites)
        {
            ...
            this.AddFavoritesToCache(favoritesToAdd);
        ...
        private bool RemoveRedundantFavorites(List<IFavorite> current, List<IFavorite> newFavorites)
        {
            ...
            this.RemoveFavoritesFromCache(favoritesToRemove);
