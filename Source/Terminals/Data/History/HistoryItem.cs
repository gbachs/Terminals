...
namespace Terminals.Data
{
    ...
    public class HistoryItem : IHistoryItem
    {
        ...
        [XmlIgnore] DateTime IHistoryItem.Date => this.Date.ToLocalTime();

        /// <summary>
        ///     Gets the user name with domain prefix in form of DOMAIN\USERNAME
        /// </summary>
        [XmlIgnore]
        string IHistoryItem.UserName => WindowsUserIdentifiers.ResolveUserNameFromSid(this.UserSid);

        /// <summary>
        ///     Gets or sets associated favorite. This is only a navigation property
        /// </summary>
        [XmlIgnore]
        IFavorite IHistoryItem.Favorite => this.Favorite;
