...
namespace Terminals.Data
{
    ...
    internal class AuthenticationSequence
    {
        ...
        internal AuthenticationSequence(Func<string, bool> isMasterPasswordValid,
        ...
        {
            var promptResults = this.knowsUserPassword(false);
            var authenticated = this.IsUserPaswordValid(promptResults);
