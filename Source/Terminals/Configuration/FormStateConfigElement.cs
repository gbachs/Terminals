...
namespace Terminals
{
    ...
    public class FormStateConfigElement : ConfigurationElement
    {
        ...
        public Size Size { get => (Size)this[SIZE]; set => this[SIZE] = value; }

        [ConfigurationProperty(LOCATION, IsRequired = true)]
        public Point Location { get => (Point)this[LOCATION]; set => this[LOCATION] = value; }

        [ConfigurationProperty(STATE, IsRequired = true)]
        public FormWindowState State { get => (FormWindowState)this[STATE]; set => this[STATE] = value; }
    }
}